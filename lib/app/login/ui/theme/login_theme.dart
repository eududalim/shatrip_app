...
class LoginTheme {
  static TextStyle get loginTitle1 => TextStyle(
        ...
        shadows: [Shadow(blurRadius: 7, color: Colors.black38, offset: Offset(3, 3))],
      );
  ...
  static ButtonStyle buttonStyle1(context) => ButtonStyle(
        ...
        overlayColor: MaterialStateProperty.all<Color>(Theme.of(context).accentColor.withAlpha(100))
      );
